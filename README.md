...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/rebuild-compact-layout`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/rebuild-compact-layout). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/rebuild-compact-layout"]
