...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/ranger-hunter-animation-cancel`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/ranger-hunter-animation-cancel). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/ranger-hunter-animation-cancel"]
