...
**Branch-aware technical guide for [`agent/replace-keybinds-from-markdown`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/replace-keybinds-from-markdown)**

<p><img alt="branch: agent/replace-keybinds-from-markdown" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Freplace-keybinds-from-markdown&color=5965F2&style=flat-square"> <img alt="Next.js" src="https://img.shields.io/static/v1?label=&message=Next.js&color=24292F&style=flat-square"> <img alt="React" src="https://img.shields.io/static/v1?label=&message=React&color=24292F&style=flat-square"> <img alt="Tailwind CSS" src="https://img.shields.io/static/v1?label=&message=Tailwind%20CSS&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/BindForge-NW/tree/agent/replace-keybinds-from-markdown"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/BindForge-NW/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/BindForge-NW/codespaces/new?ref=agent%2Freplace-keybinds-from-markdown"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/replace-keybinds-from-markdown`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/replace-keybinds-from-markdown/README.md)
- [`app/data/keybindPresetSections/artifactCombos.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/replace-keybinds-from-markdown/app/data/keybindPresetSections/artifactCombos.ts)
- [`app/data/keybindPresetSections/bardSongs.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/replace-keybinds-from-markdown/app/data/keybindPresetSections/bardSongs.ts)
- [`app/data/keybindPresetSections/characterInstanceAndAccount.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/replace-keybinds-from-markdown/app/data/keybindPresetSections/characterInstanceAndAccount.ts)
- [`app/data/keybindPresetSections/classSpecificCombos.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/replace-keybinds-from-markdown/app/data/keybindPresetSections/classSpecificCombos.ts)
- [`app/data/keybindPresetSections/combatTargetingFollowAndInteraction.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/replace-keybinds-from-markdown/app/data/keybindPresetSections/combatTargetingFollowAndInteraction.ts)
- [`app/data/keybindPresetSections/companion.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/replace-keybinds-from-markdown/app/data/keybindPresetSections/companion.ts)
- [`app/data/keybindPresetSections/customChatMessages.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/replace-keybinds-from-markdown/app/data/keybindPresetSections/customChatMessages.ts)
- [`app/data/keybindPresetSections/emotes.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/replace-keybinds-from-markdown/app/data/keybindPresetSections/emotes.ts)
- [`app/data/keybindPresetSections/inventoryAndConsumables.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/replace-keybinds-from-markdown/app/data/keybindPresetSections/inventoryAndConsumables.ts)
- [`app/data/keybindPresetSections/movementAndCamera.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/replace-keybinds-from-markdown/app/data/keybindPresetSections/movementAndCamera.ts)
- [`app/data/keybindPresetSections/onlineStatus.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/replace-keybinds-from-markdown/app/data/keybindPresetSections/onlineStatus.ts)
...
```mermaid
flowchart TD
    ROOT["BindForge-NW / agent/replace-keybinds-from-markdown"]
    ROOT --> P0["app/"]
    ROOT --> P1["docs/"]
    ROOT --> P2["public/"]
    ROOT --> P3[".gitignore"]
    ...
    ROOT --> P7["package-lock.json"]
    ROOT --> P8["package.json"]
    ROOT --> P9["postcss.config.mjs"]
    ROOT --> P10["tsconfig.json"]
```

| Responsibility | Detected source paths |
|---|---|
| Interface | [`app`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/replace-keybinds-from-markdown/app), [`public`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/replace-keybinds-from-markdown/public) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/replace-keybinds-from-markdown/docs) |
...
```mermaid
flowchart LR
    CHANGE["Change on agent/replace-keybinds-from-markdown"] --> CHECK["Tests and quality checks"]
...
| Branch | [`agent/replace-keybinds-from-markdown`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/replace-keybinds-from-markdown) |
