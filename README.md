...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/finish-all-remaining-work`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/finish-all-remaining-work). It is generated from the files present on this branch and preserves the project-authored README below.
...
flowchart TD
    ...
    R0 --> F10["app/components/PortableSharePanel.tsx"]
    R0 --> F11["app/components/RecoveryPanel.tsx"]
```
...
```mermaid
flowchart LR
    CHANGE["Change on agent/finish-all-remaining-work"]
