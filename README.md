...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/complete-r1-r2-single-pr`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/complete-r1-r2-single-pr). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/complete-r1-r2-single-pr"]
