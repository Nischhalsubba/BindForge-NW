...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/library-ui-refinement`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/library-ui-refinement). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/library-ui-refinement"]
