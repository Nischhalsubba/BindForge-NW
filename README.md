...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/record-verified-production`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/record-verified-production). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/record-verified-production"]
