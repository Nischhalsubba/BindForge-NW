...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/apply-warm-neutral-palette`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/apply-warm-neutral-palette). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/apply-warm-neutral-palette"]
