...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/finish-r1-r2`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/finish-r1-r2). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/finish-r1-r2"]
