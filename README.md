...
**Branch-aware technical guide for [`agent/full-atelier-zero-rebuild`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-atelier-zero-rebuild)**

<p><img alt="branch: agent/full-atelier-zero-rebuild" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Ffull-atelier-zero-rebuild&color=5965F2&style=flat-square"> <img alt="Next.js" src="https://img.shields.io/static/v1?label=&message=Next.js&color=24292F&style=flat-square"> <img alt="React" src="https://img.shields.io/static/v1?label=&message=React&color=24292F&style=flat-square"> <img alt="Tailwind CSS" src="https://img.shields.io/static/v1?label=&message=Tailwind%20CSS&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-atelier-zero-rebuild"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/BindForge-NW/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/BindForge-NW/codespaces/new?ref=agent%2Ffull-atelier-zero-rebuild"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/full-atelier-zero-rebuild`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/README.md)
...
```mermaid
flowchart TD
    ROOT["BindForge-NW / agent/full-atelier-zero-rebuild"]
    ROOT --> P0[".github/"]
    ROOT --> P1["app/"]
    ROOT --> P2["docs/"]
    ROOT --> P3["e2e/"]
...
|---|---|
| Interface | [`app`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-atelier-zero-rebuild/app), [`public`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-atelier-zero-rebuild/public) |
| Quality | [`tests`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-atelier-zero-rebuild/tests), [`e2e`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-atelier-zero-rebuild/e2e) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-atelier-zero-rebuild/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-atelier-zero-rebuild/.github), [`scripts`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-atelier-zero-rebuild/scripts) |
...
Relevant detected files: [`app/data/catalogIntegrity.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/app/data/catalogIntegrity.ts).
...
- [`tests`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-atelier-zero-rebuild/tests)
- [`e2e`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-atelier-zero-rebuild/e2e)
...
- [`SECURITY.md`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/SECURITY.md)
- [`.github/dependabot.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/.github/dependabot.yml)
...
```mermaid
flowchart LR
    CHANGE["Change on agent/full-atelier-zero-rebuild"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/catalog-maintenance.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/.github/workflows/catalog-maintenance.yml)
- [`.github/workflows/maintenance.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/.github/workflows/maintenance.yml)
- [`.github/workflows/production-monitor.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/.github/workflows/production-monitor.yml)
- [`.github/workflows/production-smoke.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/.github/workflows/production-smoke.yml)
- [`.github/workflows/quality.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/.github/workflows/quality.yml)
- [`.github/workflows/release.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/.github/workflows/release.yml)
- [`.github/workflows/security.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/.github/workflows/security.yml)
...
| Branch | [`agent/full-atelier-zero-rebuild`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-atelier-zero-rebuild) |
| Ownership | [`.github/CODEOWNERS`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/.github/CODEOWNERS) |
| Contributing | [`CONTRIBUTING.md`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/full-atelier-zero-rebuild/CONTRIBUTING.md) |
