...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`cloudflare/workers-autoconfig`](https://github.com/Nischhalsubba/BindForge-NW/tree/cloudflare/workers-autoconfig). It is generated from the files present on this branch and preserves the project-authored README below.
