...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/complete-r1-r2-implementation`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/complete-r1-r2-implementation). It is generated from the files present on this branch and preserves the project-authored README below.
...
flowchart TD
    ...
    R0 --> F4["app/components/CustomSayBuilder.tsx"]
    R0 --> F5["app/components/Icon.tsx"]
    R0 --> F6["app/components/RecoveryPanel.tsx"]
    R0 --> F7["app/layout.tsx"]
    R0 --> F8["app/opengraph-image.tsx"]
    R0 --> F9["app/page.tsx"]
```
...
```mermaid
flowchart LR
    CHANGE["Change on agent/complete-r1-r2-implementation"]
