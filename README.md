...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/persistent-filter-console`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/persistent-filter-console). It is generated from the files present on this branch and preserves the project-authored README below.
...
flowchart TD
    ...
    R0 --> F1["app/PersistentFilterConsole.tsx"]
...
```mermaid
flowchart LR
    CHANGE["Change on agent/persistent-filter-console"]
