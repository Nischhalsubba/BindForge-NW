...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/split-filter-sidebar-topbar`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/split-filter-sidebar-topbar). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/split-filter-sidebar-topbar"]
