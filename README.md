...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/fix-copy-feedback-build`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/fix-copy-feedback-build). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/fix-copy-feedback-build"]
