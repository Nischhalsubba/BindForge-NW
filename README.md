...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/add-card-unbind-toggle`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/add-card-unbind-toggle). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/add-card-unbind-toggle"]
