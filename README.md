...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/custom-say-message-input`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/custom-say-message-input). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/custom-say-message-input"]
