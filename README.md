...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/sticky-filter-control-dock`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/sticky-filter-control-dock). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/sticky-filter-control-dock"]
