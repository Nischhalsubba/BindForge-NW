...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/fix-sticky-icons-hero`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/fix-sticky-icons-hero). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/fix-sticky-icons-hero"]
