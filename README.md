...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/apple-theme-and-sidebar-fixes`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/apple-theme-and-sidebar-fixes). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/apple-theme-and-sidebar-fixes"]
