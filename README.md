...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/fix-live-key-combination-preview`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/fix-live-key-combination-preview). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/fix-live-key-combination-preview"]
