...
**Branch-aware technical guide for [`agent/atelier-editorial-redesign`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/atelier-editorial-redesign)**

<p><img alt="branch: agent/atelier-editorial-redesign" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Fatelier-editorial-redesign&color=5965F2&style=flat-square"> <img alt="Next.js" src="https://img.shields.io/static/v1?label=&message=Next.js&color=24292F&style=flat-square"> <img alt="React" src="https://img.shields.io/static/v1?label=&message=React&color=24292F&style=flat-square"> <img alt="Tailwind CSS" src="https://img.shields.io/static/v1?label=&message=Tailwind%20CSS&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/BindForge-NW/tree/agent/atelier-editorial-redesign"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/BindForge-NW/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/BindForge-NW/codespaces/new?ref=agent%2Fatelier-editorial-redesign"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/atelier-editorial-redesign`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/README.md)
...
```mermaid
flowchart TD
    ROOT["BindForge-NW / agent/atelier-editorial-redesign"]
    ROOT --> P0[".github/"]
    ROOT --> P1["app/"]
    ROOT --> P2["docs/"]
    ROOT --> P3["e2e/"]
...
|---|---|
| Interface | [`app`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/atelier-editorial-redesign/app), [`public`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/atelier-editorial-redesign/public) |
| Quality | [`tests`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/atelier-editorial-redesign/tests), [`e2e`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/atelier-editorial-redesign/e2e) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/atelier-editorial-redesign/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/atelier-editorial-redesign/.github), [`scripts`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/atelier-editorial-redesign/scripts) |
...
Relevant detected files: [`app/data/catalogIntegrity.ts`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/app/data/catalogIntegrity.ts).
...
- [`tests`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/atelier-editorial-redesign/tests)
- [`e2e`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/atelier-editorial-redesign/e2e)
...
- [`SECURITY.md`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/SECURITY.md)
- [`.github/dependabot.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/.github/dependabot.yml)
...
```mermaid
flowchart LR
    CHANGE["Change on agent/atelier-editorial-redesign"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/catalog-maintenance.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/.github/workflows/catalog-maintenance.yml)
- [`.github/workflows/maintenance.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/.github/workflows/maintenance.yml)
- [`.github/workflows/production-monitor.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/.github/workflows/production-monitor.yml)
- [`.github/workflows/production-smoke.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/.github/workflows/production-smoke.yml)
- [`.github/workflows/quality.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/.github/workflows/quality.yml)
- [`.github/workflows/release.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/.github/workflows/release.yml)
- [`.github/workflows/security.yml`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/.github/workflows/security.yml)
...
| Branch | [`agent/atelier-editorial-redesign`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/atelier-editorial-redesign) |
| Ownership | [`.github/CODEOWNERS`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/.github/CODEOWNERS) |
| Contributing | [`CONTRIBUTING.md`](https://github.com/Nischhalsubba/BindForge-NW/blob/agent/atelier-editorial-redesign/CONTRIBUTING.md) |
