...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/social-share-preview`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/social-share-preview). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/social-share-preview"]
