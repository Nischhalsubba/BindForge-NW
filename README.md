...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/phase-3-filter-settings-drawer`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/phase-3-filter-settings-drawer). It is generated from the files present on this branch and preserves the project-authored README below.
...
flowchart TD
    ...
    R0 --> F10["app/components/KeybindLibrary.tsx"]
    R0 --> F11["app/components/PortableSharePanel.tsx"]
```
...
```mermaid
flowchart LR
    CHANGE["Change on agent/phase-3-filter-settings-drawer"]
