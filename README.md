...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/remove-sidebar-scrollbars`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/remove-sidebar-scrollbars). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/remove-sidebar-scrollbars"]
