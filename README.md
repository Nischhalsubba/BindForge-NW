...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/workspace-field-style-fix`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/workspace-field-style-fix). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/workspace-field-style-fix"]
