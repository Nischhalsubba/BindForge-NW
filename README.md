...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/full-open-design-redesign`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/full-open-design-redesign). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/full-open-design-redesign"]
