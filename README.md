...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/implement-apple-design-spec`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/implement-apple-design-spec). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/implement-apple-design-spec"]
