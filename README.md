...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/replace-keybinds-from-markdown`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/replace-keybinds-from-markdown). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/replace-keybinds-from-markdown"]
