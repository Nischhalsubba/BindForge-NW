...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/minimal-open-design-redesign`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/minimal-open-design-redesign). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/minimal-open-design-redesign"]
