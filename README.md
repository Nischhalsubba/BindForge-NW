...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/redesign-bindforge-ui`](https://github.com/Nischhalsubba/BindForge-NW/tree/agent/redesign-bindforge-ui). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/redesign-bindforge-ui"]
