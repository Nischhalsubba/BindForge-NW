...
| keymap-analysis | Import full keymaps, compare profiles, detect conflicts, clean/migrate bindings, and maintain rollback history | character-profiles, visual-keymap |
| catalogue-intelligence | Expand commands/presets, version verification, animation-cancel evidence, and zero-result research candidates | navigation-foundation |
...
| performance-pwa | Raise runtime performance and make an explicit installability/offline decision | navigation-foundation |
